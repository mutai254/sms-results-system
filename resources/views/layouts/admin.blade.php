...
<head>
  ...
  <link rel="icon" href="{{ asset('dist/img/kibu.png')}}">
    <!-- CSRF Token -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>S</b>RC</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SB</b>RCS</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="divider"></li>
        <li><a href="{{ route('exam.index') }}"><i class="fa fa-file"></i> <span>View Exam</span></a></li>
        <li class="divider"></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="mailto:kibetmutai836@gmail.com">SBRCS</a>.</strong> All rights
    reserved.
  </footer>
